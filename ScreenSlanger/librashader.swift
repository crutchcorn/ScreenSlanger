    ...
    init() throws {
        ...
        if isAppBundle {
            ...
            paths = [
                ...
                FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent("Library/Application Support/ScreenSlanger/Tools/librashader/0.12.0/librashader.dylib").path
            ].compactMap { $0 }
        }
